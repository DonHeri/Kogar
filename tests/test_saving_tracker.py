...
def test_get_shared_by_period_includes_empty_lists_for_no_activity(tracker_with_funds):
    ...
    empty_data = tracker_with_funds.get_shared_by_period(
...
def test_integration_saving_tracker_flow(tracker):
    ...
    tracker.deposit("amanda", to_cents(100.0), SavingScope.PERSONAL, "Ahorro Amanda")
    ...
    tracker.withdraw("amanda", to_cents(50.0), SavingScope.SHARED, "Compra urgente")
