...
def test_add_months_crosses_year_forward() -> None:
    assert add_months(date(2025, 12, 20), 1) == date(2026, 1, 20)


def test_add_months_crosses_year_backward() -> None:
...
def test_add_months_clamps_on_leap_year() -> None:
...
def test_add_months_large_jump_multiple_years() -> None:
    assert add_months(date(2026, 3, 10), 24) == date(2028, 3, 10)


def test_add_months_negative_large_jump() -> None:
