...
def test_create_valid_household(base_household: Household) -> None:
...
def test_register_member_adds_to_household(
    base_household: Household, member_zero_income: Member
) -> None:
...
def test_get_total_incomes_raises_if_no_members(base_household: Household) -> None:
...
def test_get_percentages_raises_if_no_members(base_household: Household) -> None:
    """Lanza error si no hay miembros registrados"""
    with pytest.raises(ValueError, match="No hay miembros registrados"):
...
# ====================================================
def test_get_percentages_equal_splits_evenly(household_with_members: Household) -> None:
...
def test_get_percentages_equal_sums_to_10000(household_with_members: Household) -> None:
...
def test_get_percentages_equal_raises_if_no_members(base_household: Household) -> None:
    """Lanza error si no hay miembros registrados"""
    with pytest.raises(ValueError, match="No hay miembros registrados"):
...
def test_get_percentages_custom_raises_if_no_members(base_household: Household) -> None:
    """Lanza error si no hay miembros registrados"""
    with pytest.raises(ValueError, match="No hay miembros registrados"):
...
def test_validate_members_exist_raises_if_empty(base_household: Household) -> None:
...
def test_set_budget_for_category(household_with_members: Household) -> None:
...
def test_set_budget_for_child_category(household_with_members: Household) -> None:
...
def test_set_budget_for_category_multiple(household_with_members: Household) -> None:
...
def test_get_planning_summary_basic(household_with_members: Household) -> None:
...
def test_get_planning_summary_includes_debts(household_with_members: Household) -> None:
...
def test_get_planning_summary_raises_if_no_members(base_household: Household) -> None:
...
def test_set_standard_categories_populates_budget(base_household: Household) -> None:
...
def test_get_active_categories_returns_list(base_household: Household) -> None:
...
def test_get_category_budget_returns_amount(household_with_members: Household) -> None:
...
def test_get_incomes_returns_live_values(household_with_members: Household) -> None:
...
def test_assign_distribution_method_changes_percentages(
    household_with_members: Household,
) -> None:
...
def test_register_expense_adds_to_tracker(household_with_members: Household) -> None:
...
def test_get_total_spent_sums_all_expenses(household_with_members: Household) -> None:
...
def test_get_total_remaining_can_be_negative(household_with_members: Household) -> None:
...
def test_get_member_balance_normalizes_name(household_with_members: Household) -> None:
    """Debe normalizar el nombre del miembro"""
...
def test_get_member_status_normalizes_name(household_with_members: Household) -> None:
    """Debe normalizar el nombre del miembro"""
    _set_budget(household_with_members, "fijos", 100000)
    household_with_members.assign_distribution_method(MetodoReparto.EQUAL)
    household_with_members.prepare_period()
...
def test_get_budget_as_percentage_basic(household_with_members: Household) -> None:
...
@pytest.fixture
def household_month_ready(household_with_members: Household) -> Household:
