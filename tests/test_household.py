...
def test_get_unbudgeted_income_by_member_with_equal_method(
    household_with_members_standard_categories: Household,
) -> None:
    ...
    share_m1 = (
        household_with_members_standard_categories.get_unbudgeted_income_by_member(
            "member1"
        )
    )
    share_m2 = (
...
def test_get_unbudgeted_income_by_member_with_custom_method(
    household_with_members_standard_categories: Household,
) -> None:
