...
def test_format_percentage_converts_correctly() -> None:
    """Convierte basis points a string de porcentaje"""
    assert format_percentage(5357) == "53.57%"


def test_format_percentage_round_number() -> None:
...
def test_format_percentage_returns_string() -> None:
    """El resultado es siempre string"""
    assert isinstance(format_percentage(5000), str)


def test_format_percentage_includes_symbol() -> None:
    """El resultado siempre incluye el símbolo %"""
...
def test_percentage_roundtrip() -> None:
